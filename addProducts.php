...
$sql="INSERT INTO products (productID, productName, productCategory, productDescription, productAmount, productCost, productTotalCost,productRegistrationDate) VALUES ('$_POST[productID]','$_POST[productName]','$_POST[productCategory]','$_POST[productDescription]','$_POST[productAmount]','$_POST[productCost]',productAmount*productCost,CURRENT_TIMESTAMP())";

if (!mysqli_query($con, $sql))
  {
  die('Error: ' . mysqli_error());
  }
echo "<b>One product is stored into database!</b>";
