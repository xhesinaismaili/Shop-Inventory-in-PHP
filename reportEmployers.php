...
<head>
<title>Report Employers | "Xhesi" Shop Inventory Management SystemSystem</title>
    ...
    $(document).ready(
		function () {
            ...
            <div id="menu" align="center"><ul>
					<li><a href="#">   *** Report Employers ***</a></li></ul></div>
                    <br/>
                    <br/>
                    <br/>
...
$res= "select count(*) from employers";
	$query=mysqli_query($con,$res);

	while($row = mysqli_fetch_array($query)){
		echo "<b>Total Employers</b> of Xhesi Shop Inventory Management System= ".$row;
	}
